...
// 					$connec=mysqli_connect("localhost","root","","address_book");
...
//                     $Result_Select=mysqli_query($connec,$Query_Select);
// 					while($row_select=mysqli_fetch_array($Result_Select))
// {
						//	?>
							<div class="media">
								<a class="pull-left" href="#!">
									<img class="media-object" src="/Pro_Images/<?php echo $row_select['Product_Image']?>" alt="image" />
								</a>
								<div class="media-body">
									<h4 class="media-heading"><a href="#!"><?php echo $row_select['Product_Name']?></a></h4>
									
									<h4><strong><?php echo $row_select['Product_Price']?></strong></h4>
								</div>
								<a href="emptycart.php?cart_id=<?php echo $row_select['Cart_id']?>" class="remove"><i class="tf-ion-close"></i></a>

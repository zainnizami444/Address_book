...
$Result_Select = mysqli_query($conn,$Query_Select);
          ...
          <form action="productdetails.php" method="post">
            ...
            <label>Product </label>
          <input type="text" class="form-control pull-right"  name="Product" placeholder=""/>

<label>Cosmetics </label>
    <select name="category" class="form-control pull-left" >

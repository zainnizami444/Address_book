...
$Query_Insert="INSERT INTO `tbl_cart` VALUES (NULL,$User_id,$Product_id,1,$Product_Price,'Pending')";
						...
						<div class="preview-meta">
							<ul>
								...
								<li><form action="" method="post">
									...
									<a href ="Single_Product.php?Product_id=<?php echo $row['Product_id']?> name="Btn_cart" class="btn btn-light btn-lg text-dark">
									<i class="tf-ion-ios-search-strong"></i></a>
			</form>
								</li>
							</ul>
                      	</div>
